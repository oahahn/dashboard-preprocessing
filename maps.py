species_name_map = {
    ...
    'Bird Species': ['Roosting Birds?', 'Flock Of Birds', 'Bird Of Prey', 'Bird Of Prey On Nest', 'Bird On Nest', 'Birds',
            ...
            'Wedge-Tailed Eagle', 'Quail', 'Rosella', 'White Faced Hero', 'Topknot Pigeon', 'White-Faced Heron',
            'Unidentified Rosella', 'Unidentified Corvid', 'Galah/Pink Cockatoo', 'Mallee Ringneck',
                     'Unidentified Corvid'],
