species_name_map = {
    ...
    'Ground Species': ['2 Ground Unsure Medium Size - Review?', 'Unknown Ground', 'Macro? Ground',
               ...
               'Ground Sp', 'Small', 'Unsure', 'Uncertain'],
    ...
    'Musk Lorikeet': [],
    'Other': ['other - add details in notes'],
    'Owl': ['Owl Sp.', 'Large Owl'],
    'Pademelon': ['Paddy Melon', 'Pademelon/ Parma Wallaby', 'Pademelon/Parma', 'Pademelon/ Parma Wallaby (Plus Koala)'],
    ...
    'Swamp Wallaby': [],
    'Rabbit': ['Rabbits'],
    'Rock': ['Rocks?', 'possibly hot rocks', 'maybe rock?'],
    'Termite Nest': ['Termite Mound', 'Termite', 'Arboreal Termite Nest?', 'Tree Growth/ Termites', 'Termite Or Hollow', 'bulge on branch'],
    'Tree Hollow': ['Animal In Chimney Hollow', 'Hollow Possible Occupants', 'Tree Hollow To Rd',
                    ...
                    'Occupied Hollow (In Fallen Stag)', 'Hollow', 'hbt'],
    'Unspecified': ['Unknown - Not A Koala', 'Unknown (X2)', 'Unknown (Fast?)', 'Unknown, Small', 'Unvalidated',
                ...
                '', 'nan', 'NaN', 'Other', 'Unknown', 'cannot tell? wasp nest?', 'uncertain'],
